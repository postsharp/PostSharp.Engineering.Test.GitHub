...
object ReleaseBuild : BuildType({
    ...
    dependencies {
        dependency(AbsoluteId("Test_Test20231_PostSharpEngineeringTestTestProduct_ReleaseBuild")) {
            snapshot {
                     onDependencyFailure = FailureAction.FAIL_TO_START
            }
...
object DownstreamMerge : BuildType({
    ...
    steps {
        powerShell {
            ...
            noProfile = false
            param("jetbrains_powershell_scriptArguments", "tools git merge-downstream --ci-branch %teamcity.build.branch%  %DownstreamMergeArguments%")
        }
    }
